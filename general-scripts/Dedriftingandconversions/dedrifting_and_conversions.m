function[] = dedrifting_and_conversions(basepath, take, smoo, scalefactor, remBeads)
...
% (time axis hardcoded in "drift_loop").
%
...
res_acc = from_8_columnns_to_4(res,remBeads);

ddposum = pixtomicro(res_acc,scalefactor);      %converts it from pixels to microns, using hardcoded values
